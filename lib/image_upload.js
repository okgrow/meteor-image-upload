...
var imageUpload = new ImageUpload(myAccessKeyId, mySecretAccessKey, myBucketName);
...
ImageUpload can optionally take an options parameter. If you want to
...
ImageUpload = function (accessKeyId, secretAccessKey, bucketName, options) {
  ...
  // full size
  this.createCollection = function (collectionName, sizes) {
    factory.stores.push(
